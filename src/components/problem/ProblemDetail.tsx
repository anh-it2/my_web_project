        ...
        >
          ...
          <motion.div variants={cardVariants}>
            ...
            >
              ...
              <div className="flex items-center gap-4 text-gray-600 mb-4">
                <span className="font-medium text-base">{t("difficulty")}:</span>
            ...
            {data.tags.map((tag, index) => (
              ...
              <div className="flex gap-6 mb-4 text-gray-700">
                <div className="flex flex-row gap-2 items-center">
                  <span className="font-medium text-base">{t("visibility")}:</span>{" "}
                  <span
          ...
          <motion.div variants={cardVariants}>
            <Card className="p-6 rounded-2xl shadow-sm border">
              <h2 className="text-xl font-semibold mb-4">{t("sampleTest")}</h2>
              <Table
